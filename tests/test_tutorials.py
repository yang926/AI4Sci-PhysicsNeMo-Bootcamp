...
from tutorial.runtime import informer
...
basic = load("tutorial_basic_test", "tutorial/introduction/source_code/pinn_basics.py")
projectile = load("tutorial_projectile_test", "tutorial/projectile/source_code/projectile.py")
diffusion = load("tutorial_diffusion_test", "tutorial/diffusion_1d/source_code/diffusion_bar.py")
navier = load("tutorial_navier_test", "tutorial/navier_stokes/source_code/navier_stokes.py")
...
def test_existing_output_directory_is_preserved(tmp_path):
    ...
    from tutorial.runtime import setup
