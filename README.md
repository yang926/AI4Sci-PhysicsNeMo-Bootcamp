...
This course covers physics-informed neural networks and neural operators using PhysicsNeMo 2.2.2 and Python 3.12.

Open [Start Here](Start_Here.ipynb) for the course order. Read the lessons on GitHub or run them in JupyterLab. The four Labs provide complete examples. In the four Challenges, fill in the linked Python files, save them, then run the notebook and check the results.
...
Compatibility and problem-setting changes are recorded in the [migration notes](ETC/course_materials/MIGRATION.md).
