...
python ai4sci/wave/wave_baseline.py --steps 1000 --device cpu --output-dir runs/wave-reference
"""
...
if __name__ == "__main__":
    script = Path(__file__).resolve().parents[2] / "challenge/wave/wave_l1.py"
