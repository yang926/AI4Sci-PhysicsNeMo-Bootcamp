"""Level 3: Circular domain, two Gaussian sources and Robin boundary. PhysicsNeMo 2.2.2 explicit-loop PINN.
...
def initial_displacement(coordinates):
    ...
    return torch.exp(-20 * ((x - .3) ** 2 + y ** 2)) + torch.exp(-20 * ((x + .3) ** 2 + y ** 2))
